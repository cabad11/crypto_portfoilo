...
const PortfolioChart = () => {
  ...
  return (
    <div className="background-standard ring-standard rounded-3xl p-6 md:p-8 shadow-xl relative overflow-hidden">
      <button
        className="ring-standard absolute right-6 top-6 md:right-8 md:top-8 z-10 rounded-xl w-8 h-8 background-interactive"
        onClick={refresh}
        aria-label="Refresh"
      >
